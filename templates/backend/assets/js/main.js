$(document).ready(function() {
  ...
  $(document).on('change','.permission-all', function() {
	...
	$(document).on("change",'.orders-change-update',function() {
	    var $this = $(this);
	...
	$(document).on('focus','.orders-blur-update',function(){
      var $thiscosting = $(this);
      $thiscosting.data('before', $thiscosting.val());
      return $thiscosting;
  });
	$(document).on("blur",'.orders-blur-update',function() {
		 var $thiscosting = $(this);
	...
	$(document).on("click",'.orders-click-update',function() {
